...
import 'package:FoodCourtApp/screens/checkout/check.dart';
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          Check(meals: purchasedList, counters: counters)));
            },
          )
        ],
      ),
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Text(
                              '${purchasedList[index].name} x ${counters[index]}',
                        ...
                        child: Row(
                          children: [
                            Padding(
                              ...
                              child: Text(
                                  '${purchasedList[index].price.toString()}L.E',
                                  style: TextStyle(
